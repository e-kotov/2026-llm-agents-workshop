...
The workshop runs in a specialized container that includes all necessary tools. See the [figure](#fig-VS Code-interface) below for the main elements of the VS Code interface in the Codespace environment. Click the image to zoom in.


::: {#fig-VS Code-interface}

![](media/VS Code-main-annotated.png)
...
::: {#fig-VS Code-open-folder-new-window}

{{< video media/videos/VS Code-open-folder-as-project-new-window.mp4 title='Opening a folder as a new project' >}}
...
::: {#fig-VS Code-open-terminal-in-folder}

{{< video media/videos/VS Code-open-folder-in-terminal.mp4 title='Opening terminal in a specific folder' >}}
...
::: {#fig-VS Code-open-folder}

![](media/VS Code-open-folder.png)
...
::: {#fig-VS Code-file-explorer}

{{< video media/videos/VS Code-file-explorer.mp4 >}}
